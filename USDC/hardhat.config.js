...
module.exports = {
  ...
  paths: {
    //sources: "./src1/contracts", // 1st Start ImplementationContract-FiatTokenV2_1 Needed
    //sources: "./src2/contracts", // 2nd USDC FitTokenProxy need FiatTokenV2_1 Contract
    sources: "./src3/contracts", // 3rd FiatTokenUtil need FiatTokenV2_1 Contract
